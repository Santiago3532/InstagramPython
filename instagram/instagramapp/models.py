...
class Follow(models.Model):
    username_sigue = models.ForeignKey( MiUsuario,related_name = '%(class)s_username_sigue') #En esta columna van a estar los usuarios
    username_sigo = models.ForeignKey( MiUsuario, related_name = '%(class)s_username_sigo')

class Post(models.Model):
    foto = models.CharField(max_length = 600, null = False)
